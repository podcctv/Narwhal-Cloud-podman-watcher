...
auto_remediate_panel="$(load_non_empty_or_default "$CLIENT_ENV_FILE" SECURITY_AUTO_REMEDIATE_PANEL "true")"
auto_remediate_socks="$(load_non_empty_or_default "$CLIENT_ENV_FILE" SECURITY_AUTO_REMEDIATE_SOCKS "true")"
...
SECURITY_AUTO_REMEDIATE_PANEL=$auto_remediate_panel
SECURITY_AUTO_REMEDIATE_SOCKS=$auto_remediate_socks
