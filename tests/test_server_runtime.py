...
class ServerRuntimeTests(unittest.TestCase):
    ...
    def test_automatic_update_unit_allows_image_build_wait(self):
        ...
        self.assertNotIn("Delegate=yes", setup)
        ...
        self.assertIn('podman run -d "${PODMAN_CGROUP_ARGS[@]}"', server_installer)
        ...
        self.assertIn('run -d "${PODMAN_CGROUP_ARGS[@]}" --name "$TLS_CONTAINER_NAME"', server_installer)
